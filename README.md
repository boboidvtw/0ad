...
本 Fork 計畫以 **0 A.D. / Pyrogenesis 為基礎，製作受《Empire Earth》（世紀爭霸）跨時代玩法啟發的原創 RTS 全面改造 Mod（Total Conversion）**。目前第一階段已建立 Mod、測試地圖與自訂單位，引擎測試、實際畫面、選取／移動與正常退出驗收均已通過。跨時代玩法尚未實作；上游既有功能不代表改造功能已完成。
